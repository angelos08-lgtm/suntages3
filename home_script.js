  ...
  .then(html => {
    ...
    main.innerHTML = `
      ...
      <div id="extra1" class="story-extra">
        <p>
          Οι κουραμπιέδες έχουν τις ρίζες τους στη Μικρά Ασία, όπου γλυκίσματα με βούτυρο και ξηρούς καρπούς ήταν σύμβολο φιλοξενίας και γιορτής. 
          ...
          Σε πολλές περιοχές, μάλιστα, οι κουραμπιέδες θεωρούνταν γλυκό καλής τύχης, και το πρώτο ταψί ψηνόταν παραμονή Χριστουγέννων “για το καλό του σπιτιού”.
        </p>
        <!-- SLIDER Κουραμπιέδες -->
      ...
      <div id="extra2" class="story-extra">
        <p>
          Τα μελομακάρονα έχουν πολύ βαθιά ιστορία. Η αρχαία ρίζα τους είναι τα “μακαρώνια” — τελετουργικές προσφορές σε τελετές και μνημόσυνα, φτιαγμένες από αλεύρι, λάδι και μέλι. 
          ...
          Τελικά επικράτησε ως χριστουγεννιάτικο έδεσμα γιατί το λάδι (αντί βουτύρου) ταίριαζε με τις νηστίσιμες ημέρες πριν τις γιορτές.
        </p>
        <!-- SLIDER Μελομακάρονα -->
      ...
      <div id="extra3" class="story-extra">
        <p>
          Οι δίπλες είναι βαθιά συνδεδεμένες με την Πελοπόννησο, όπου παραδοσιακά φτιάχνονταν όχι μόνο τα Χριστούγεννα, αλλά και σε γάμους και βαφτίσια. 
          Το όνομά τους προέρχεται από το τύλιγμα (“δίπλωμα”) του φύλλου την ώρα που τηγανίζεται. Το μέλι συμβολίζει τη γλυκύτητα και την ευλογία, ενώ το καρύδι τη γονιμότητα και την αφθονία.
        </p>
        <!-- SLIDER Δίπλες -->
